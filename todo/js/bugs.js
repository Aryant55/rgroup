class TodoList1 {
    constructor() {
        this.todos = new Map();
        this.todoContainer = document.querySelector(".todo-body1");
        this.todoList = document.querySelector(".todo-list1");
        this.todoInput = document.querySelector(".todoInput1");
        this.removeButton = document.querySelector(".removeText1");
        this.bindEvents();
    }
