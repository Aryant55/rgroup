class TodoList2 {
    constructor() {
        this.todos = new Map();
        this.todoContainer = document.querySelector(".todo-body2");
        this.todoList = document.querySelector(".todo-list2");
        this.todoInput = document.querySelector(".todoInput2");
        this.removeButton = document.querySelector(".removeText2");
        this.bindEvents();
    }
